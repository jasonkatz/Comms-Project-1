...
% SYMBOLS
bits = randi([0 1],512 * numChannels * k,1); % Generate random bits, pass these out of function, unchanged
%bits = ones(64*k,1);
...
for i = 1:numChannels
    ...
    msgPart = msg(i:numChannels:msglength);
